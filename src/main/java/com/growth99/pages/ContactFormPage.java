...
public class ContactFormPage {
	...
	String thankYouUrl="https://www.monarchcharleston.com/thank-you"; //you website thank you URL
	...
	public void scrollToGetInTouch()
	{
		webUtils.scrollToElement(getInTouch);
	}
	...
	public void clickOnConsentCheckbox() {
		webUtils.isElementSelected(consentCheckbox);
